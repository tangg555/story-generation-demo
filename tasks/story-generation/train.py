...
from src.configuration.story_generation.config_args import parse_args_for_config
from src.models.story_generation import LeadingContextBart
...
class EventTriggerTrainer(BasicPLTrainer):
    ...
    def _init_model(self, args):
        ...
        # ============= bart ===============
        if are_same_strings(args.model_name, "leading-bart"):
